...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "pwmfrequency" -parent ${Page_0}
...
proc update_PARAM_VALUE.pwmfrequency { PARAM_VALUE.pwmfrequency } {
	# Procedure called to update pwmfrequency when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.pwmfrequency { PARAM_VALUE.pwmfrequency } {
	# Procedure called to validate pwmfrequency
	return true
}
...
proc update_MODELPARAM_VALUE.pwmfrequency { MODELPARAM_VALUE.pwmfrequency PARAM_VALUE.pwmfrequency } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.pwmfrequency}] ${MODELPARAM_VALUE.pwmfrequency}
}
