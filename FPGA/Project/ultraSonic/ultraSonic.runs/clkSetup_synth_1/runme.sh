...
HD_PWD='C:/Studies/FPGA/practice/test/ultraSonic/ultraSonic.runs/clkSetup_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkSetup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkSetup.tcl
