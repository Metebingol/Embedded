...
HD_PWD='C:/Studies/FPGA/practice/test/ultraSonic/ultraSonic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sonic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sonic.tcl -notrace
