...
HD_PWD='C:/Studies/FPGA/practice/test/ultraSonic/ultraSonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sonic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sonic.tcl
