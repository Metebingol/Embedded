...
HD_PWD='C:/Studies/EmbeddedSystemRepo/Embedded-System/FPGA/libraries/xADC/xADC.runs/xadcSetup_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadcSetup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadcSetup.tcl
