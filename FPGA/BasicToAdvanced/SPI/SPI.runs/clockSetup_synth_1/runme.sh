...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/SPI/SPI.runs/clockSetup_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockSetup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockSetup.tcl
