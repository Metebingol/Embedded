...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithSecond_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlazeWithSecond_wrapper.tcl
