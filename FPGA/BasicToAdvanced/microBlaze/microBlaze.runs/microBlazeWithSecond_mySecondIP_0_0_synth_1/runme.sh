...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/microBlazeWithSecond_mySecondIP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithSecond_mySecondIP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlazeWithSecond_mySecondIP_0_0.tcl
