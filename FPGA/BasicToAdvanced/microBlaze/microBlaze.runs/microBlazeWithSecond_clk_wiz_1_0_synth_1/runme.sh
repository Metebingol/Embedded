...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/microBlazeWithSecond_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithSecond_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlazeWithSecond_clk_wiz_1_0.tcl
