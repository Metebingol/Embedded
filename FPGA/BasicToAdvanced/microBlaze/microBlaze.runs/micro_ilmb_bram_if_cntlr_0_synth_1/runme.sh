...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/micro_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_ilmb_bram_if_cntlr_0.tcl
