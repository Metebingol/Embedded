...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/microBlazeWithFirst_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithFirst_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlazeWithFirst_axi_gpio_0_0.tcl
