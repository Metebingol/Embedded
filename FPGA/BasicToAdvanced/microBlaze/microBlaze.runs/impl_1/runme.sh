...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithSecond_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microBlazeWithSecond_wrapper.tcl -notrace
