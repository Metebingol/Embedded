...
HD_PWD='C:/Studies/Embedded/FPGA/BasicToAdvanced/microBlaze/microBlaze.runs/microBlazeWithFirst_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microBlazeWithFirst_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microBlazeWithFirst_mdm_1_0.tcl
